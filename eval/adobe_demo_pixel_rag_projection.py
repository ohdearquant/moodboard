...
def project(*, root: Path, output_dir: Path) -> dict[str, Any]:
    root = root.resolve()
    evidence_dir = root / ".cache/adobe-demo-khive-state/evidence"
    manifest_path = (
        root / ".cache/adobe-demo-public-domain-v1/run-20260812-final-current/manifest.json"
    )
    ...
    compositor_path = (
        root / ".cache/adobe-demo-generated-v1/provenance/apple-to-lemon-mask-enforced-v3.json"
    )
    ...
    measurements: dict[str, Any] = {
        ...
        "projection": {
            "revision": "moodboard.adobe-demo-frozen-evidence-projection.v1",
